#5) Você está em uma sala com três interruptores, cada um 
# conectado a uma lâmpada em salas diferentes. Você não 
# pode ver as lâmpadas da sala em que está, mas pode ligar 
# e desligar os interruptores quantas vezes quiser. Seu 
